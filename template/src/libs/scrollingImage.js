...
export default class ScrollingBackground extends Component {
  ...
  constructor(props) {
    ...
    let deviceWidth = props.width || Dimensions.get('window').width;
    let deviceHeight = props.height || Dimensions.get('window').height;
    ...
    switch (this.props.direction) {
      case 'left':
        ...
        if (this.props.width) {
          ...
          height = `${
            (this.props.width * Dimensions.get('window').height) /
