      ...
      <ImageBackground
        ...
        <ScrollView>
          <View
            ...
            <View style={{ marginLeft: 8, marginRight: 42 }}>
              <Text style={styleText}>
                {t('Check out 2 steps to start sharing your location:')}
              </Text>
            </View>
            <View
              style={{
              ...
              <Image
                resizeMode='contain'
                source={getImage('beLocateOnboarding')}
                style={{
                  width: '100%',
                  height: '100%',
                }}
          ...
          <View
            ...
            <CustomButton
              onPress={() => navigation.navigate('OnBoardingByQrBeLocated')}
              title={t('Next')}
            />
          </View>
        </ScrollView>
...
export default BeLocateOnBoardingStart;
