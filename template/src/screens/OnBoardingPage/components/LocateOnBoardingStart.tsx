      ...
      <ImageBackground
        ...
        <ScrollView>
          <View
            ...
            <View style={{ marginLeft: 8, marginBottom: 12 }}>
              <Text style={styleText}>
                {t('Check out 3 steps to start locating others')}:
              </Text>
            </View>
            <View
              style={{
              ...
              <Image
                resizeMode='contain'
                source={getImage('imageOnboarding1')}
                style={{
                  width: '100%',
                  height: '100%',
                }}
          ...
          <View
            ...
            <CustomButton
              onPress={() => navigation.navigate('OnBoardingMap')}
              title={t('Next')}
            />
          </View>
        </ScrollView>
...
export default LocateOnBoardingStart;
