      ...
      <ImageBackground
        ...
        <ScrollView>
          <View
            ...
            <View style={{ marginLeft: 8, marginRight: 12 }}>
              <Text style={styleText}>
                {t(
                  `Ask your loved one to paste the code on their 'Be Located' page`,
                )}
              </Text>
            </View>
            <View
          ...
          <View
            ...
            <CustomButton
              onPress={() => navigation.navigate('OnBoardView')}
              title={t('Next')}
            />
          </View>
        </ScrollView>
...
export default OnBoardingByCode;
