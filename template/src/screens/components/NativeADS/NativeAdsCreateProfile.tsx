...
import { ANDROID_NATIVE_PROFILE, IOS_NATIVE_PROFILE } from '@env';

const NativeAdsCreateProfile = React.memo(
  ({ onPress }: { onPress: (arg: boolean) => void }): JSX.Element => {
    ...
    const ID_Native =
      Platform.OS === 'android' ? ANDROID_NATIVE_PROFILE : IOS_NATIVE_PROFILE;
...
export default NativeAdsCreateProfile;
