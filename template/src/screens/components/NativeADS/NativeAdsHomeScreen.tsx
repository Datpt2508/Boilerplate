...
import { ANDROID_NATIVE_HOME, IOS_NATIVE_HOME } from '@env';

const NativeAdsHomeScreen = React.memo(
  ({ onPress }: { onPress: (arg: boolean) => void }): JSX.Element => {
    ...
    const ID_Native =
      Platform.OS === 'android' ? ANDROID_NATIVE_HOME : IOS_NATIVE_HOME;
...
export default NativeAdsHomeScreen;
